...
import {
  dateAnswerPropsSchema,
  DateAnswerPropsSchemaType,
} from "../../schemas/date-answer";
...
const Props = ({ element }: Prop) => {
  ...
  const form = useForm<DateAnswerPropsSchemaType>({
    resolver: zodResolver(dateAnswerPropsSchema),
    mode: "onBlur",
    defaultValues: {
      question: question,
  ...
  function applyChanges(values: DateAnswerPropsSchemaType) {
